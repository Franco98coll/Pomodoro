...
const agregarTarea = async () => {
    try {
        const response = await fetch('http://serverpomodoro-production.up.railway.app/tarea', {
            method: 'POST',
            headers: {
...
const obtenerTareas = async () => {
    try {
        const response = await fetch(`http://serverpomodoro-production.up.railway.app/tareas`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
